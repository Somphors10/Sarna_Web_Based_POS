...
return [
    ...
    "os_timezone"                               => "Часова зона WBPOS:",
    "ospos_info"                                => "Інформація про встановлення WBPOS",
    "payment_options_order"                     => "Варіанти оплати замовлення",
    "perm_risk"                                 => "Неправильні дозволи роблять WBPOS вразливим.",
    ...
    "timezone_error"                            => "Часовий пояс WBPOS відрізняється від вашого місцевого часового поясу.",
    "top"                                       => "Головний",
