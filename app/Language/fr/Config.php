...
return [
    ...
    "os_timezone"                               => "Fuseau horaire d'WBPOS :",
    "ospos_info"                                => "Informations d'installation d'WBPOS",
    ...
    "timezone_error"                            => "Le fuseau horaire d'WBPOS est différent de votre fuseau horaire local.",
    "top"                                       => "Haut",
