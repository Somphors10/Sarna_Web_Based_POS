...
return [
    ...
    "center"                                    => "Centro",
    "change_apperance_tooltip"                  => "Cambiar Aspecto de WBPOS",
    "comma"                                     => "coma",
    ...
    "ospos_info"                                => "Información de la Instalación WBPOS",
    ...
    "timezone_error"                            => "La zona horaria de WBPOS es diferente de tu zona horaria local.",
    "top"                                       => "Arriba",
    "use_destination_based_tax"                 => "Usar Impuesto Basado en Destino",
    "user_timezone"                             => "Zona Horaria WBPOS:",
    "website"                                   => "Sitio Web",
