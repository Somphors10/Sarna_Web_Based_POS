...
return [
    ...
    "country"                        => "ប្រទេស",
    "dashboard"                      => "",
    "password_strong"                => "ពាក្យសម្ងាត់ត្រូវមានយ៉ាងតិច 8 តួអក្សរ រួមមានអក្សរធំ អក្សរតូច លេខ និងសញ្ញាពិសេស។",
    "password_strong_hint"           => "យ៉ាងតិច 8 តួ មានអក្សរធំ/តូច លេខ និងសញ្ញា (ឧ. Wbpos@Shop2026)។",
    "date"                           => "កាលបរិច្ឆេទ",
    "delete"                         => "លុប",
    "det"                            => "លម្អិត",
