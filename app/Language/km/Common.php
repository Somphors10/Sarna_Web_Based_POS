...
return [
    ...
    "country"                        => "ប្រទេស",
    "dashboard"                      => "",
    "password_strong"                => "សូមជ្រើសពាក្យសម្ងាត់ឱ្យរឹងមាំជាងនេះ (យ៉ាងតិច 8 តួ ពិបាកទាយ)។",
    "password_strong_hint"           => "យ៉ាងតិច 8 តួ។ ប្រើពាក្យសម្ងាត់វែង ឬលាយអក្សរ លេខ និងសញ្ញា — ជម្រើសរបស់អ្នក គ្រាន់តែឱ្យរឹងមាំ។",
    "date"                           => "កាលបរិច្ឆេទ",
    "delete"                         => "លុប",
    "det"                            => "លម្អិត",
