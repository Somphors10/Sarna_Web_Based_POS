...
return [
    ...
    "os_timezone"                               => "Fuso horário do WBPOS:",
    "ospos_info"                                => "Informações de instalação do WBPOS",
    ...
    "timezone_error"                            => "O fuso horário do WBPOS é diferente do fuso horário local.",
    "top"                                       => "Topo",
