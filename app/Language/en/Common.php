...
return [
    ...
    "password_strong"                => "Please choose a stronger password (at least 8 characters, hard to guess).",
    "password_strong_hint"           => "At least 8 characters. Use a long password or mix letters, numbers, and symbols — your choice, just make it strong.",
    "date"                           => "Date",
    "delete"                         => "Delete",
    "det"                            => "details",
