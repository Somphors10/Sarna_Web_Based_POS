...
return [
    ...
    "default_receivings_discount"               => "Default Purchase Discount",
    "default_receivings_discount_number"        => "Default Purchase Discount must be a number.",
    "default_receivings_discount_required"      => "Default Purchase Discount is a required field.",
    ...
    "recv_invoice_format"                       => "Purchase Invoice Format",
