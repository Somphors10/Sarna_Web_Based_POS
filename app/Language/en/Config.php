...
return [
    ...
    "default_receivings_discount"               => "Default Receiving Discount",
    "default_receivings_discount_number"        => "Default Receiving Discount must be a number.",
    "default_receivings_discount_required"      => "Default Receiving Discount is a required field.",
    ...
    "subscription_request_date"                 => "Request Date",
    "subscription_request_date_hint"            => "Date this shop registered for WBPOS. Read only.",
    "subscription_expires_date"                 => "Expires Date",
    "subscription_expires_date_hint"            => "Current subscription end date. Renew before this date to keep using POS.",
    "subscription_status_expired"               => "Expired",
    "subscription_days_left"                    => "{0} day(s) left",
    ...
    "tax_id"                                    => "VAT TIN",
    "cambodia_vat_hint"                         => "Cambodia VAT is 10%. Keep Tax Included off so the receipt shows price without VAT, then VAT, then total. Also show the total in Khmer Riel.",
    "khr_exchange_rate"                         => "KHR rate (1 USD)",
    "khr_exchange_rate_note"                    => "Printed on receipts. Use the National Bank of Cambodia daily rate.",
    "tax_included"                              => "Tax Included",
    "theme"                                     => "Theme",
    "theme_preview"                             => "Preview Theme:",
    "thousands_separator"                       => "Thousands Separator",
    "timezone"                                  => "Timezone",
    "timezone_error"                            => "WBPOS Timezone is Different from your Local Timezone.",
    "top"                                       => "Top",
