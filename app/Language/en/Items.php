...
return [
    ...
    "cannot_be_restored"                 => "Could not restore the selected item(s).",
    ...
    "filters_count_selected"             => "{0} filters selected",
    "filters_none_selected"              => "Item filters",
    "filters_title"                      => "Filter items list",
    ...
    "supplier"                           => "Supplier",
    "tab_active"                         => "Active items",
    "tab_deleted"                        => "Deleted items",
    "tax_1"                              => "VAT",
    "tax_2"                              => "VAT 2",
    "tax_3"                              => "",
