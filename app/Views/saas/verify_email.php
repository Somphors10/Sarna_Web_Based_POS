...
<main class="lp-success">
    <div class="lp-success__shell saas-shell">
        <div class="lp-success__card">
            ...
            <h1 class="lp-success__title"><?= $ok ? ($already ? 'Already verified' : 'You\'re verified') : 'Could not verify' ?></h1>
            <p class="lp-success__lead">
                <?php if ($ok): ?>
                    Super Admin can now review your registration. After they activate, you will receive the KHQR by email.
                <?php else: ?>
