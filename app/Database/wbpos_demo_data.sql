...
DELETE FROM `wbpos_sales_payments` WHERE `payment_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_sales_items_taxes` WHERE `sale_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_sales_taxes` WHERE `sale_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_sales_items` WHERE `sale_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_sales_reward_points` WHERE `sale_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_sales` WHERE `sale_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_receivings_items` WHERE `receiving_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_receivings` WHERE `receiving_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_expenses` WHERE `expense_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_giftcards` WHERE `giftcard_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_cash_up` WHERE `cashup_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_inventory` WHERE `trans_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_item_kit_items` WHERE `item_kit_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_item_kits` WHERE `item_kit_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_item_quantities` WHERE `item_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_items_taxes` WHERE `item_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_items` WHERE `item_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_customers` WHERE `person_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_suppliers` WHERE `person_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_expense_categories` WHERE `expense_category_id` BETWEEN 1001 AND 1999;
DELETE `g` FROM `wbpos_grants` `g` WHERE `g`.`person_id` BETWEEN 1021 AND 1999;
DELETE FROM `wbpos_employees` WHERE `person_id` BETWEEN 1021 AND 1999;
DELETE FROM `wbpos_people` WHERE `person_id` BETWEEN 1001 AND 1999;
DELETE FROM `wbpos_stock_locations` WHERE `location_id` BETWEEN 1002 AND 1999 AND `tenant_id` = 1;
DELETE FROM `wbpos_dinner_tables` WHERE `dinner_table_id` BETWEEN 1001 AND 1999;

-- Clear old tenant 1 transactional rows (low IDs from earlier imports)
DELETE FROM `wbpos_sales_payments` WHERE `tenant_id` = 1 AND `sale_id` < 1001;
DELETE FROM `wbpos_sales_items` WHERE `tenant_id` = 1 AND `sale_id` < 1001;
DELETE FROM `wbpos_sales` WHERE `tenant_id` = 1 AND `sale_id` < 1001;
DELETE FROM `wbpos_receivings_items` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_receivings` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_expenses` WHERE `tenant_id` = 1 AND `expense_id` < 1001;
DELETE FROM `wbpos_giftcards` WHERE `tenant_id` = 1 AND `giftcard_id` < 1001;
DELETE FROM `wbpos_cash_up` WHERE `tenant_id` = 1 AND `cashup_id` < 1001;
DELETE FROM `wbpos_inventory` WHERE `tenant_id` = 1 AND `trans_id` < 1001;
DELETE FROM `wbpos_item_kit_items` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_item_kits` WHERE `tenant_id` = 1 AND `item_kit_id` < 1001;
DELETE FROM `wbpos_item_quantities` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_items_taxes` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_items` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_customers` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_suppliers` WHERE `tenant_id` = 1;
DELETE FROM `wbpos_expense_categories` WHERE `tenant_id` = 1;
DELETE `g` FROM `wbpos_grants` `g` INNER JOIN `wbpos_people` `p` ON `g`.`person_id` = `p`.`person_id` WHERE `p`.`tenant_id` = 1 AND `p`.`person_id` > 1 AND `p`.`person_id` < 1001;
DELETE FROM `wbpos_employees` WHERE `tenant_id` = 1 AND `person_id` > 1 AND `person_id` < 1001;
DELETE FROM `wbpos_people` WHERE `tenant_id` = 1 AND `person_id` > 1 AND `person_id` < 1001;
...
-- Role-specific permissions (not full admin copy)
...
('reports_expenses_categories', 1025, 'home'), ('reports_payments', 1025, 'home'), ('reports_sales', 1025, 'home'), ('reports_taxes', 1025, 'home'), ('cashups', 1025, 'home');
